...
package com.example.cura.Camera2Kit;
...
import com.example.cura.TinyDB;
    ...
    Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        for (Size option : choices) {
            if (option.getWidth() <= maxWidth && option.getHeight() <= maxHeight) {
                mPreviewSizes.add(new com.example.cura.Camera2Kit.Size(option.getWidth(), option.getHeight()));
        ...
        if (bigEnough.size() > 0) {
            ...
            SortedSet<com.example.cura.Camera2Kit.Size> sortedSet = mPreviewSizes.sizes(mAspectRatio);
            if (sortedSet != null) {
                com.example.cura.Camera2Kit.Size lastSize = sortedSet.last();
